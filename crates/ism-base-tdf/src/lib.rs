...
pub const PACKAGE_NAME: &str = "BASE-TDF";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "cfc95f362531f193a41a30a489ae02358756d6eeb51359c8a4f0f447d5c17c14";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 355;
...
/// Path to the package's data directory: `data/BASE-TDF`.
