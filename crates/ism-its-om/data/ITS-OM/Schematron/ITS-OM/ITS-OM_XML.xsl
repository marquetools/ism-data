...
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">ITS-OM-ID-00001</xsl:attribute>
            <xsl:attribute name="name">ITS-OM-ID-00001</xsl:attribute>
            <svrl:text>
...
<!--PATTERN ITS-OM-ID-00001-->


	<!--RULE -->
<xsl:template match="*[@ism:DESVersion]" priority="1000" mode="M3">
