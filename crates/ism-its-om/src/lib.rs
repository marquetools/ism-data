...
pub const PACKAGE_NAME: &str = "ITS-OM";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "5ee1fb50d69bda2d94c40c7989929404f89fcab402b4910d77313676fbbcbb48";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 313;
...
/// Path to the package's data directory: `data/ITS-OM`.
