...
Vendored ODNI **ITS-OM** schema package, with SHA-256 integrity verification
at compile time.
...
# Cargo.toml
[build-dependencies]
ism-its-om = { git = "https://github.com/marquetools/ism-data", tag = "v..." }
```

```rust,ignore
// build.rs
let xsd = ism_its_om::package_root().join("Schema/ITS-OM/ITS-OM.xsd");
