...
pub const PACKAGE_NAME: &str = "CDR-RA";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "85b38ec9985833254f8e21f454518ee193c3d968bc77d2bf8546970b17138231";
...
/// Path to the package's data directory: `data/CDR-RA`.
