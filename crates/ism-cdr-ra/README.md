...
Vendored ODNI **CDR-RA** schema package, with SHA-256 integrity verification
at compile time.
...
# Cargo.toml
[build-dependencies]
ism-cdr-ra = { git = "https://github.com/marquetools/ism-data", tag = "v..." }
```

```rust,ignore
// build.rs
let xsd = ism_cdr_ra::package_root().join("Schema/CDR-RA/CDR-RA.xsd");
