...
Vendored ODNI **AUTHCAT** schema package, with SHA-256 integrity verification
at compile time.
...
# Cargo.toml
[build-dependencies]
ism-authcat = { git = "https://github.com/marquetools/ism-data", tag = "v..." }
```

```rust,ignore
// build.rs
let xsd = ism_authcat::package_root().join("Schema/AUTHCAT/AUTHCAT.xsd");
