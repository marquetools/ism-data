...
pub const PACKAGE_NAME: &str = "AUTHCAT";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "a95b2ab999c6113079569f8fb862da863ca716df749f6b5fd65429df78d10774";
...
/// Path to the package's data directory: `data/AUTHCAT`.
