...
pub const PACKAGE_NAME: &str = "RR-SM";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "9ebb1f404a46a1959fcaa0404da420ad51d9dfbecd26c0af60e947131f1fc9c1";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 946;
...
/// Path to the package's data directory: `data/RR-SM`.
