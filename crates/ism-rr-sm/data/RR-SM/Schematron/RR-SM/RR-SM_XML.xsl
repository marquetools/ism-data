...
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">RR-SM-ID-00001</xsl:attribute>
            <xsl:attribute name="name">RR-SM-ID-00001</xsl:attribute>
            <svrl:text>
        [RR-SM-ID-00001][Error] The @ism:DESVersion is less than the minimum version 
        allowed: 9. 
        
        Human Readable: The ism version imported by RR-SM must be greater than or equal to 9. 
    </svrl:text>
            <svrl:text>
        ...
        is greater than or equal to the minimum allowed version: 9.  
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">RR-SM-ID-00002</xsl:attribute>
            <xsl:attribute name="name">RR-SM-ID-00002</xsl:attribute>
            <svrl:text>
...
<xsl:choose>
   ...
   <!--PATTERN RR-SM-ID-00002-->


	<!--RULE -->
<xsl:template match="*[@arh:DESVersion]" priority="1000" mode="M5">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="*[@arh:DESVersion]"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="number(@arh:DESVersion) &gt;= 1"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="number(@arh:DESVersion) &gt;= 1">
               <xsl:attribute name="flag">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
