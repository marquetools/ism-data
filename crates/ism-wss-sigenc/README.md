...
Vendored ODNI **WSS-SIGENC** schema package, with SHA-256 integrity verification
at compile time.
...
# Cargo.toml
[build-dependencies]
ism-wss-sigenc = { git = "https://github.com/marquetools/ism-data", tag = "v..." }
```

```rust,ignore
// build.rs
let xsd = ism_wss_sigenc::package_root().join("Schema/WSS-SIGENC/WSS-SIGENC.xsd");
