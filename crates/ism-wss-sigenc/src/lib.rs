...
pub const PACKAGE_NAME: &str = "WSS-SIGENC";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "89165f634a885cc8cd0f91fb936f7ccf63535ba847609893200f7952129f0761";
...
/// Path to the package's data directory: `data/WSS-SIGENC`.
