...
pub const PACKAGE_NAME: &str = "ARH";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "457b038b7ca31d3bc10ba8fa220fdcf561a170946f5e1deeec4dd54e1769f98e";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 279;
...
/// Path to the package's data directory: `data/ARH`.
