...
pub const PACKAGE_NAME: &str = "DHZM";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "d4e1fe6827c4f2147eeb97851d91e1123d0f6cfda177986216292cbcffe76e2e";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 184;
...
/// Path to the package's data directory: `data/DHZM`.
