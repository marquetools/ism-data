...
pub const PACKAGE_NAME: &str = "CSR";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "cb6c380cbde2dc538bcaaab2cac8d86a890648fb65b66218a4cda6e3c5a0dfb7";
...
/// Path to the package's data directory: `data/CSR`.
