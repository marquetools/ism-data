...
pub const PACKAGE_NAME: &str = "QM";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "0d2211c9f0832aef14aed6036d5ea2c15d8c3bb2623414677320bf990a64193e";
...
/// Path to the package's data directory: `data/QM`.
