...
Vendored ODNI **ISM-Rollup** schema package, with SHA-256 integrity verification
at compile time.
...
# Cargo.toml
[build-dependencies]
ism-ism-rollup = { git = "https://github.com/marquetools/ism-data", tag = "v..." }
```

```rust,ignore
// build.rs
let xsd = ism_ism_rollup::package_root().join("Schema/ISM-Rollup/ISM-Rollup.xsd");
