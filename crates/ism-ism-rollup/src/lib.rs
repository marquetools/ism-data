...
pub const PACKAGE_NAME: &str = "ISM-Rollup";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "5c73f92c409d67c866086fa74133a778e682c365b4989c3237f6feb5898937dd";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 30;
...
/// Path to the package's data directory: `data/ISM-Rollup`.
