...
Vendored ODNI **DELIVER** schema package, with SHA-256 integrity verification
at compile time.
...
# Cargo.toml
[build-dependencies]
ism-deliver = { git = "https://github.com/marquetools/ism-data", tag = "v..." }
```

```rust,ignore
// build.rs
let xsd = ism_deliver::package_root().join("Schema/DELIVER/DELIVER.xsd");
