...
pub const PACKAGE_NAME: &str = "DELIVER";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "8fbc7c9826da759c3be54305312bc2d3223eb8bce0be76eaf6506a6e607e0afe";
...
/// Path to the package's data directory: `data/DELIVER`.
