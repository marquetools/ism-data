...
<xsl:template match="/">
      ...
      declares some variables, and includes all of the Rule .sch files.</svrl:text>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">DHZM-TDF-ID-00001</xsl:attribute>
            <xsl:attribute name="name">DHZM-TDF-ID-00001</xsl:attribute>
            <svrl:text> 
        [DHZM-TDF-ID-00001][Warning] tdf:version attribute SHOULD be specified
        as version 202111-DHZM-TDF.202111 with an optional extension. 
    </svrl:text>
            <svrl:text>
        ...
        expression “^202111-DHZM-TDF.202111(-.{1,23})?$". 
    </svrl:text>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">DHZM-TDF-ID-00002</xsl:attribute>
            <xsl:attribute name="name">DHZM-TDF-ID-00002</xsl:attribute>
            <svrl:text>
        ...
        The calling rule must pass in '202111', 'ISM', '../../Schema/ISM/IC-ISM.xsd', 'DHZM-TDF-ID-00002'.</svrl:text>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">DHZM-TDF-ID-00003</xsl:attribute>
            <xsl:attribute name="name">DHZM-TDF-ID-00003</xsl:attribute>
            <svrl:text>
        This abstract pattern checks to see if the validation environment has at least the version / revision of the
        Schema as of the writing of this specification. 
        The calling rule must pass in '201903', 'IC-EDH', '../../Schema/IC-EDH/IC-EDH.xsd', 'DHZM-TDF-ID-00003'.</svrl:text>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">DHZM-TDF-ID-00004</xsl:attribute>
            <xsl:attribute name="name">DHZM-TDF-ID-00004</xsl:attribute>
            <svrl:text>
        This abstract pattern checks to see if the validation environment has at least the version / revision of the
        Schema as of the writing of this specification. 
        The calling rule must pass in '202111', 'RevRecall', '../../Schema/RevRecall/RevRecall_XML.xsd', 'DHZM-TDF-ID-00004'.</svrl:text>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">DHZM-TDF-ID-00005</xsl:attribute>
            <xsl:attribute name="name">DHZM-TDF-ID-00005</xsl:attribute>
            <svrl:text>
        This abstract pattern checks to see if the validation environment has at least the version / revision of the
        Schema as of the writing of this specification. 
        The calling rule must pass in '202111', 'BASE-TDF', '../../Schema/BASE-TDF/BASE-TDF.xsd', 'DHZM-TDF-ID-00005'.</svrl:text>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">DHZM-TDF-ID-00006</xsl:attribute>
            <xsl:attribute name="name">DHZM-TDF-ID-00006</xsl:attribute>
            <svrl:text>
        This abstract pattern checks to see if the validation environment has at least the version / revision of the
        Schema as of the writing of this specification. 
        The calling rule must pass in '202111', 'IC-SF', '../../Schema/IC-SF/IC-SF.xsd', 'DHZM-TDF-ID-00006'.</svrl:text>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">DHZM-TDF-ID-00007</xsl:attribute>
            <xsl:attribute name="name">DHZM-TDF-ID-00007</xsl:attribute>
            <svrl:text>
        This abstract pattern checks to see if the validation environment has at least the version / revision of the
        Schema as of the writing of this specification. 
        The calling rule must pass in '202111', 'DHZM', '../../Schema/DHZM/DHZM.xsd', 'DHZM-TDF-ID-00007'.</svrl:text>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">DHZM-TDF-ID-00008</xsl:attribute>
            <xsl:attribute name="name">DHZM-TDF-ID-00008</xsl:attribute>
            <svrl:text>
        This abstract pattern checks to see if the validation environment has at least the version / revision of the
        Schema as of the writing of this specification. 
        The calling rule must pass in '202111', 'ANLYS', '../../Schema/ANLYS/ANLYS.xsd', 'DHZM-TDF-ID-00008'.</svrl:text>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">DHZM-TDF-ID-00009</xsl:attribute>
            <xsl:attribute name="name">DHZM-TDF-ID-00009</xsl:attribute>
            <svrl:text> 
        ...
        In a DHZM-TDF tdf:TrustedDataObject, there must be a dhzm:DigitalHazMatAssertion and only 1 of them.
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">DHZM-TDF-ID-00010</xsl:attribute>
            <xsl:attribute name="name">DHZM-TDF-ID-00010</xsl:attribute>
            <svrl:text> 
...
<!--PATTERN DHZM-TDF-ID-00001-->


	<!--RULE DHZM-TDF-ID-00001-R1-->
<xsl:template match="*[@tdf:version]" priority="1000" mode="M8">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[@tdf:version]"
                       id="DHZM-TDF-ID-00001-R1"/>

		    <!--ASSERT warning-->
<xsl:choose>
         <xsl:when test="matches(@tdf:version, '^202111-DHZM-TDF.202111(\-.{1,23})?$')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="matches(@tdf:version, '^202111-DHZM-TDF.202111(\-.{1,23})?$')">
               ...
               <svrl:text> 
            [DHZM-TDF-ID-00001][Warning] tdf:version attribute SHOULD be specified as version 202111-DHZM-TDF.202111
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text> 
            [<xsl:text/>
                  <xsl:value-of select="'DHZM-TDF-ID-00002'"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text> 
            [<xsl:text/>
                  <xsl:value-of select="'DHZM-TDF-ID-00003'"/>
                  <xsl:text/>][Error] Version [ <xsl:text/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text> 
            [<xsl:text/>
                  <xsl:value-of select="'DHZM-TDF-ID-00004'"/>
                  <xsl:text/>][Error] Version [ <xsl:text/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text> 
            [<xsl:text/>
                  <xsl:value-of select="'DHZM-TDF-ID-00005'"/>
                  <xsl:text/>][Error] Version [ <xsl:text/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text> 
            [<xsl:text/>
                  <xsl:value-of select="'DHZM-TDF-ID-00006'"/>
                  <xsl:text/>][Error] Version [ <xsl:text/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text> 
            [<xsl:text/>
                  <xsl:value-of select="'DHZM-TDF-ID-00007'"/>
                  <xsl:text/>][Error] Version [ <xsl:text/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text> 
            [<xsl:text/>
                  <xsl:value-of select="'DHZM-TDF-ID-00008'"/>
                  <xsl:text/>][Error] Version [ <xsl:text/>
   ...
   <!--PATTERN DHZM-TDF-ID-00009-->


	<!--RULE DHZM-TDF-ID-00009-R1-->
<xsl:template match="tdf:TrustedDataObject" priority="1000" mode="M16">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="tdf:TrustedDataObject"
                       id="DHZM-TDF-ID-00009-R1"/>
