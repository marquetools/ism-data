...
<sch:pattern xmlns:ism="urn:us:gov:ic:ism" xmlns:sch="http://purl.oclc.org/dsdl/schematron"
    id="DHZM-TDF-ID-00003" is-a="ValidateValidationEnvSchema">
    <sch:p class="ruleText" ism:ownerProducer="USA" ism:classification="U">
        [DHZM-TDF-ID-00003][Error] Regardless of the version indicated on the instance document,
        the validation infrastructure MUST use a version of 'IC-EDH' that is version '201903'
        (Version:2019-MAR) or later. NOTE: This is not an error of the instance
    ...
    <sch:param name="RuleID" value="'DHZM-TDF-ID-00003'"/>
</sch:pattern>
