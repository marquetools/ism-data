...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xd:doc scope="stylesheet">
        <xd:desc>
            ...
            <xd:p>Add back DHZM-TDF namespaces after processing DHZM-TDF schema for guards.</xd:p>
        </xd:desc>
    </xd:doc>
    ...
    <xsl:template match="xs:schema">
        <xsl:copy>
            ...
            <xsl:namespace name="edh" select="'urn:us:gov:ic:edh'"></xsl:namespace>
            <xsl:namespace name="arh" select="'urn:us:gov:ic:arh'"></xsl:namespace>
            <xsl:namespace name="rr" select="'urn:us:gov:ic:revrecall'"></xsl:namespace>
