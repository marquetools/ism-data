...
<xsl:template match="ch:changes">
  ...
  <xslo:stylesheet xmlns:edh="urn:us:gov:ic:edh" xmlns:arh="urn:us:gov:ic:arh" xmlns:rr="urn:us:gov:ic:revrecall" xmlns:dhzm="urn:us:gov:ic:digitalhazmat" xmlns:anlys="urn:us:gov:ic:anlysassert">
      ...
      <xslo:element name="{{name(/*)}}" namespace="{{namespace-uri(/*)}}">
        <xslo:copy-of select="(/ | document(''))/*/
                     namespace::*[.!='http://www.w3.org/1999/XSL/Transform'
                              and .!='urn:x-us:gov:ic:dhzm:changes']"/>
