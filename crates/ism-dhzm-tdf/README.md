...
Vendored ODNI **DHZM-TDF** schema package, with SHA-256 integrity verification
at compile time.
...
# Cargo.toml
[build-dependencies]
ism-dhzm-tdf = { git = "https://github.com/marquetools/ism-data", tag = "v..." }
```

```rust,ignore
// build.rs
let xsd = ism_dhzm_tdf::package_root().join("Schema/DHZM-TDF/DHZM-TDF.xsd");
