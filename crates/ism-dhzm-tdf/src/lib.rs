...
pub const PACKAGE_NAME: &str = "DHZM-TDF";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "f13c26b4ad4fecaa92ba12cbd82d6f2196524157d77def6497eedbd2edcb34c6";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 857;
...
/// Path to the package's data directory: `data/DHZM-TDF`.
