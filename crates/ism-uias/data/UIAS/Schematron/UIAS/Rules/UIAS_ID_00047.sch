<?xml version="1.0" encoding="UTF-8"?><?ICEA pattern?><!-- Notices - Distribution Notice: 
       ...
       --><sch:pattern xmlns:sch="http://purl.oclc.org/dsdl/schematron" id="UIAS-ID-00047">
    ...
    <sch:rule id="UIAS-ID-00047-R1" context="saml:AttributeStatement">
        <sch:assert test="saml:Attribute[@Name='auditRoutingOrganization']" flag="error" role="error">
