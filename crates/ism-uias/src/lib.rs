...
pub const PACKAGE_NAME: &str = "UIAS";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "691c357c78e1b057d293960593740b19f8a4cd7da7f61d4ac8f9039e0d180966";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 513;
...
/// Path to the package's data directory: `data/UIAS`.
