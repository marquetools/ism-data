...
pub const PACKAGE_NAME: &str = "UIAS-APCS";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "b2289faa7be72fbb4043bb1b96d52eadf6f5a745cf43a03d5d2e3571401880a6";
...
/// Path to the package's data directory: `data/UIAS-APCS`.
