...
Vendored ODNI **UIAS-APCS** schema package, with SHA-256 integrity verification
at compile time.
...
# Cargo.toml
[build-dependencies]
ism-uias-apcs = { git = "https://github.com/marquetools/ism-data", tag = "v..." }
```

```rust,ignore
// build.rs
let xsd = ism_uias_apcs::package_root().join("Schema/UIAS-APCS/UIAS-APCS.xsd");
