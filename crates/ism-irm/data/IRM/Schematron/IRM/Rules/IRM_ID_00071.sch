...
<sch:pattern xmlns:ism="urn:us:gov:ic:ism"
    ...
    <sch:p class="ruleText"
           ...
           ism:ownerProducer="USA">[IRM-ID-00071][Error] If element irm:type has attribute @irm:qualifier specified as
           [urn:us:gov:ic:cvenum:irm:maliciouscodeindicator] the attribute @irm:value must be in CVEnumIRMMaliciousCodeIndicator.xml. Human Readable:
           Malicious Code Indicator values must be in the CVEnumIRMMaliciousCodeIndicator CVE.</sch:p>
    ...
    <sch:param name="ruleText"
               value="' [IRM-ID-00071][Error] If element irm:type has attribute @irm:qualifier specified as [urn:us:gov:ic:cvenum:irm:maliciouscodeindicator] the attribute @irm:value must be in CVEnumIRMMaliciousCodeIndicator.xml. Human Readable: Malicious Code Indicator values must be in the CVEnumIRMMaliciousCodeIndicator CVE. '" />
    ...
    <sch:param name="searchTerm"
               value="@irm:value" />
    <sch:param name="list"
               value="$maliciousCodeIndicatorList" />
