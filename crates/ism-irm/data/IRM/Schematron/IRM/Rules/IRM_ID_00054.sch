...
<sch:pattern xmlns:ism="urn:us:gov:ic:ism"
    ...
    <sch:p class="ruleText"
           ...
           ism:ownerProducer="USA">[IRM-ID-00054][Error] If element irm:geospatialCoverage has attribute @irm:precedence specified, then the value
           must be in CVEnumIRMCoveragePrecedence.xml. Human Readable: Geospatial Coverage Precedence must be in the CVEnumIRMCoveragePrecedence
           CVE.</sch:p>
    ...
    <sch:param name="ruleText"
               value="' [IRM-ID-00054][Error] If element irm:geospatialCoverage has attribute @irm:precedence specified, then the value must be in CVEnumIRMCoveragePrecedence.xml. Human Readable: Geospatial Coverage Precedence must be in the CVEnumIRMCoveragePrecedence CVE. '" />
    ...
    <sch:param name="searchTerm"
               value="@irm:precedence" />
    <sch:param name="list"
               value="$coveragePrecedenceList" />
