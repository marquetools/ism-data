...
pub const PACKAGE_NAME: &str = "DED";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "f8038eadb7a643bdd72e01b55ea49a82db97059f6790f1664e63f65fe9a39242";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 301;
...
/// Path to the package's data directory: `data/DED`.
