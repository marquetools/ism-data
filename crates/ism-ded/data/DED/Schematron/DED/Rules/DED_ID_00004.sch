...
<?ICEA pattern?><!-- Notices - Distribution Notice: 
    ...
    <sch:p class="ruleText" ism:ownerProducer="USA" ism:classification="U">[DED-ID-00004][Error] Regardless of the version indicated on the instance document, 
            the validation infrastructure MUST use a version of 'IC-EDH' that is version '201903' (Version:2019-MAR) or later. NOTE: This is not an error of the instance
    ...
    <sch:param name="RuleID" value="'DED-ID-00004'"/>
</sch:pattern>