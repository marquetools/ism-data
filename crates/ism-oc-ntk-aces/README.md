...
Vendored ODNI **OC-NTK-ACES** schema package, with SHA-256 integrity verification
at compile time.
...
# Cargo.toml
[build-dependencies]
ism-oc-ntk-aces = { git = "https://github.com/marquetools/ism-data", tag = "v..." }
```

```rust,ignore
// build.rs
let xsd = ism_oc_ntk_aces::package_root().join("Schema/OC-NTK-ACES/OC-NTK-ACES.xsd");
