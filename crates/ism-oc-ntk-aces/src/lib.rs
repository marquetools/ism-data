...
pub const PACKAGE_NAME: &str = "OC-NTK-ACES";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "ce892c30bdb81de2a18825ae23b10ad111f10e69629cc7edf56005362fcaceff";
...
/// Path to the package's data directory: `data/OC-NTK-ACES`.
