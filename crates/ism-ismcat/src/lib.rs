...
pub const PACKAGE_NAME: &str = "ISMCAT";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "15959b20732ec629d46d1da5bcac46e6dcd6a1072a1afcf3772c88ac69223c1e";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 487;
...
/// Path to the package's data directory: `data/ISMCAT`.
