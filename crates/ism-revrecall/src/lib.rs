...
pub const PACKAGE_NAME: &str = "RevRecall";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "3715d88d500950bf3703fc07ed74f9395c15f9c02abe4e89c88bc5c56e971bf8";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 465;
...
/// Path to the package's data directory: `data/RevRecall`.
