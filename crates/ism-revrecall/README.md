...
Vendored ODNI **RevRecall** schema package, with SHA-256 integrity verification
at compile time.
...
# Cargo.toml
[build-dependencies]
ism-revrecall = { git = "https://github.com/marquetools/ism-data", tag = "v..." }
```

```rust,ignore
// build.rs
let xsd = ism_revrecall::package_root().join("Schema/RevRecall/RevRecall.xsd");
