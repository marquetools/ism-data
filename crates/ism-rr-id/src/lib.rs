...
pub const PACKAGE_NAME: &str = "RR-ID";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "de3a32df6dda260d859d79ef9e5a1e813056b05c583d50411e0982281ee2da35";
...
/// Path to the package's data directory: `data/RR-ID`.
