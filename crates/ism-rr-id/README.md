...
Vendored ODNI **RR-ID** schema package, with SHA-256 integrity verification
at compile time.
...
# Cargo.toml
[build-dependencies]
ism-rr-id = { git = "https://github.com/marquetools/ism-data", tag = "v..." }
```

```rust,ignore
// build.rs
let xsd = ism_rr_id::package_root().join("Schema/RR-ID/RR-ID.xsd");
