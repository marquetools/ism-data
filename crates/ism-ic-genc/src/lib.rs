...
pub const PACKAGE_NAME: &str = "IC-GENC";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "b31f61f2c669b8bfa7888e513d4904fb589c80db2eb8c886defaec621e7d9c16";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 242;
...
/// Path to the package's data directory: `data/IC-GENC`.
