...
Vendored ODNI **IC-GENC** schema package, with SHA-256 integrity verification
at compile time.
...
# Cargo.toml
[build-dependencies]
ism-ic-genc = { git = "https://github.com/marquetools/ism-data", tag = "v..." }
```

```rust,ignore
// build.rs
let xsd = ism_ic_genc::package_root().join("Schema/IC-GENC/IC-GENC.xsd");
