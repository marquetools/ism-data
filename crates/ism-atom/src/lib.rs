...
pub const PACKAGE_NAME: &str = "ATOM";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "b408140b4093b0b4a4ad7d7f0d09bc9c62140691800299c882665bde7c49b14d";
...
/// Path to the package's data directory: `data/ATOM`.
