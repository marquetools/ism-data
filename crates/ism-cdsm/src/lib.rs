...
pub const PACKAGE_NAME: &str = "CDSM";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "3ea417b996dba4a19b24077c91ad62b89f4ebe75f341e7ca307c45040a51fe49";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 125;
...
/// Path to the package's data directory: `data/CDSM`.
