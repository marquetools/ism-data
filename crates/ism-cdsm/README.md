...
Vendored ODNI **CDSM** schema package, with SHA-256 integrity verification
at compile time.
...
# Cargo.toml
[build-dependencies]
ism-cdsm = { git = "https://github.com/marquetools/ism-data", tag = "v..." }
```

```rust,ignore
// build.rs
let xsd = ism_cdsm::package_root().join("Schema/CDSM/CDSM.xsd");
