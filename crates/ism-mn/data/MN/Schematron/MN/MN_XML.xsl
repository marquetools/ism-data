...
<!--UNCLASSIFIED--><xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
                ...
                xmlns:region="urn:us:gov:ic:region"
...
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:ns-prefix-in-attribute-values uri="urn:us:gov:ic:region" prefix="region"/>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">MN-ID-00001</xsl:attribute>
            <xsl:attribute name="name">MN-ID-00001</xsl:attribute>
            <svrl:text>
...
<!--PATTERN MN-ID-00001-->
	...
	<!--RULE MN-ID-00001-R1-->
<xsl:template match="*[@mn:CESVersion]" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[@mn:CESVersion]"
                       id="MN-ID-00001-R1"/>

		    <!--ASSERT warning-->
<xsl:choose>
         <xsl:when test="matches(@mn:CESVersion,'^202111(\-.{1,23})?$')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="matches(@mn:CESVersion,'^202111(\-.{1,23})?$')">
            ...
            [MN-ID-00001][Warning] mn:CESVersion attribute SHOULD be specified as version 202111 (Version:2021-NOV) with an optional extension. 
            Found :<xsl:text/>
                  <xsl:value-of select="./@mn:CESVersion"/>
                  <xsl:text/>
               </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
