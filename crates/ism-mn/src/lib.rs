...
pub const PACKAGE_NAME: &str = "MN";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "43a3d3a9981d136814f368b1af97fc3c317b8cbda058e6cb8a3fefa4629b1bfa";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 167;
...
/// Path to the package's data directory: `data/MN`.
