...
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:ns-prefix-in-attribute-values uri="urn:us:gov:ic:its" prefix="its"/>
         <svrl:active-pattern>
            <xsl:attribute name="document">
               <xsl:value-of select="document-uri(/)"/>
            </xsl:attribute>
            <xsl:attribute name="id">ITS-MS-ID-00001</xsl:attribute>
            <xsl:attribute name="name">ITS-MS-ID-00001</xsl:attribute>
            <svrl:text>
        ...
        is greater than or equal to the minimum allowed version: 2014-DEC (201412).
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">ITS-MS-ID-00002</xsl:attribute>
            <xsl:attribute name="name">ITS-MS-ID-00002</xsl:attribute>
            <svrl:text>
        ...
        “^201502.201807(-.{1,23})?$".
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">ITS-MS-ID-00003</xsl:attribute>
            <xsl:attribute name="name">ITS-MS-ID-00003</xsl:attribute>
            <svrl:text>
...
<!--PATTERN ITS-MS-ID-00001-->


	<!--RULE ITS-MS-ID-00001-R1-->
<xsl:template match="*[@ism:DESVersion]" priority="1000" mode="M5">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[@ism:DESVersion]"
                       id="ITS-MS-ID-00001-R1"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="$version &gt;= 201412">
               ...
               <svrl:text>
            [ITS-MS-ID-00001][Error] The @ism:DESVersion <xsl:text/>
                  <xsl:value-of select="./@ism:DESVersion"/>
                  <xsl:text/> is less than the minimum version 
            allowed: 2014-DEC (201412). 
   ...
   <!--PATTERN ITS-MS-ID-00002-->


	<!--RULE ITS-MS-ID-00002-R1-->
<xsl:template match="*[@DESVersion]" priority="1000" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[@DESVersion]"
                       id="ITS-MS-ID-00002-R1"/>

		    <!--ASSERT warning-->
<xsl:choose>
         <xsl:when test="matches(@DESVersion,'^201502.201807(-.{1,23})?$')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="matches(@DESVersion,'^201502.201807(-.{1,23})?$')">
               ...
               <svrl:text>
            [ITS-MS-ID-00002][Warning] DESVersion attributes found was "<xsl:text/>
                  <xsl:value-of select="@DESVersion"/>
                  <xsl:text/>" it SHOULD be 
   ...
   <!--PATTERN ITS-MS-ID-00003-->


	<!--RULE ITS-MS-ID-00003-R1-->
<xsl:template match="*[@tdf:version]" priority="1000" mode="M7">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[@tdf:version]"
                       id="ITS-MS-ID-00003-R1"/>
      <xsl:variable name="version"
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="$version &gt;= 201412">
               ...
               <svrl:text>
            [ITS-MS-ID-00003][Error] The @tdf:version <xsl:text/>
