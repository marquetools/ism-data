...
pub const PACKAGE_NAME: &str = "ITS-MS";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "b1936346eae68ab9701b283194314c955ef6fd711b1c066a296c8ee6ca489ffd";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 400;
...
/// Path to the package's data directory: `data/ITS-MS`.
