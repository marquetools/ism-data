...
Vendored ODNI **ITS-MS** schema package, with SHA-256 integrity verification
at compile time.
...
# Cargo.toml
[build-dependencies]
ism-its-ms = { git = "https://github.com/marquetools/ism-data", tag = "v..." }
```

```rust,ignore
// build.rs
let xsd = ism_its_ms::package_root().join("Schema/ITS-MS/ITS-MS.xsd");
