...
pub const PACKAGE_NAME: &str = "FAC";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "43f33463578d8192598111c059530047d5658da0b31f4446f47a7c6c0b303f6d";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 161;
...
/// Path to the package's data directory: `data/FAC`.
