...
pub const PACKAGE_NAME: &str = "MAC";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "b398106c7c1de0c1abca91557700e2c98b65eba205dba4917441e858f31a7580";
...
/// Path to the package's data directory: `data/MAC`.
