...
pub const PACKAGE_NAME: &str = "IC-SF";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "95ccc6012c7d3d6310d23c5ca313f470cdbc22b102553e4b1fda52d83e36be9c";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 78;
...
/// Path to the package's data directory: `data/IC-SF`.
