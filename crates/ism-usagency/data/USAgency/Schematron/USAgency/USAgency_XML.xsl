...
<xsl:template match="*[@usagency:CESVersion]" priority="1000" mode="M3">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT warning-->
<xsl:choose>
         <xsl:when test="matches(@usagency:CESVersion,'^201703.201802(\-.{1,23})?$')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="matches(@usagency:CESVersion,'^201703.201802(\-.{1,23})?$')">
