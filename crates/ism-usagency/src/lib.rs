...
pub const PACKAGE_NAME: &str = "USAgency";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "a91527ce75c13b638b7489e35ccd90ca43787323479222a521e2cdeba6f38233";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 120;
...
/// Path to the package's data directory: `data/USAgency`.
