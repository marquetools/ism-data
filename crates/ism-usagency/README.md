...
Vendored ODNI **USAgency** schema package, with SHA-256 integrity verification
at compile time.
...
# Cargo.toml
[build-dependencies]
ism-usagency = { git = "https://github.com/marquetools/ism-data", tag = "v..." }
```

```rust,ignore
// build.rs
let xsd = ism_usagency::package_root().join("Schema/USAgency/USAgency.xsd");
