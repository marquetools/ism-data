...
pub const PACKAGE_NAME: &str = "CEM";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "5d882393350c5907381ce736e74f4e92ec8807309fb7a2e6b8cfd0f17502aead";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 283;
...
/// Path to the package's data directory: `data/CEM`.
