...
<xsl:stylesheet xmlns:d="http://docbook.org/ns/docbook" xmlns:exsl="http://exslt.org/common" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" exclude-result-prefixes="exsl d">
...
<xsl:template name="article.titlepage.recto">
  ...
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="d:articleinfo/d:date"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="d:artheader/d:date"/>
  ...
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="d:artheader/d:mediaobject"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="d:info/d:mediaobject"/>
...
<xsl:template name="article.titlepage.before.verso"><fo:block break-after="page"/>
</xsl:template>
...
<fo:block xsl:use-attribute-sets="article.titlepage.recto.style" space-before="12.96pt" font-size="17.28pt">
<xsl:apply-templates select="." mode="article.titlepage.recto.mode"/>
</fo:block>
</xsl:template>

<xsl:template match="d:mediaobject" mode="article.titlepage.recto.auto.mode">
<fo:block xsl:use-attribute-sets="article.titlepage.recto.style" space-before="10.8pt">
<xsl:apply-templates select="." mode="article.titlepage.recto.mode"/>
</fo:block>
</xsl:template>
...
<fo:block xsl:use-attribute-sets="article.titlepage.recto.style" space-before="3em" font-family="{$body.fontset}" text-align="start">
<xsl:apply-templates select="." mode="article.titlepage.recto.mode"/>
</fo:block>
</xsl:template>
...
<fo:block xsl:use-attribute-sets="article.titlepage.recto.style" text-align="start" font-family="{$body.fontset}">
<xsl:apply-templates select="." mode="article.titlepage.recto.mode"/>
</fo:block>
</xsl:template>
...
<xsl:template name="book.titlepage.recto">
  ...
  <xsl:apply-templates mode="book.titlepage.recto.auto.mode" select="d:bookinfo/d:annotation"/>
  <xsl:apply-templates mode="book.titlepage.recto.auto.mode" select="d:info/d:annotation"/>
...
<fo:block xsl:use-attribute-sets="book.titlepage.recto.style" text-align="center" space-before="10.8pt">
<xsl:apply-templates select="." mode="book.titlepage.recto.mode"/>
</fo:block>
</xsl:template>

<xsl:template match="d:title" mode="book.titlepage.recto.auto.mode">
<fo:block xsl:use-attribute-sets="book.titlepage.recto.style" text-align="center" font-size="24.8832pt" space-before="10.8pt" font-weight="bold" font-family="{$title.fontset}">
<xsl:call-template name="division.title">
...
<fo:block xsl:use-attribute-sets="book.titlepage.recto.style" text-align="center" font-size="24.8832pt" space-before="10.8pt" font-weight="bold" font-family="{$title.fontset}" border-bottom="4.5pt double #7a251d" padding-bottom=".5em" margin-bottom="1em">
<xsl:apply-templates select="." mode="book.titlepage.recto.mode"/>
</fo:block>
</xsl:template>

<xsl:template match="d:edition" mode="book.titlepage.recto.auto.mode">
<fo:block xsl:use-attribute-sets="book.titlepage.recto.style" text-align="start" font-size="24.8832pt" space-before="18.6624pt" font-family="{$title.fontset}" margin-left="1.5in">
<xsl:apply-templates select="." mode="book.titlepage.recto.mode"/>
</fo:block>
</xsl:template>

<xsl:template match="d:pubdate" mode="book.titlepage.recto.auto.mode">
<fo:block xsl:use-attribute-sets="book.titlepage.recto.style" text-align="start" font-size="17.28pt" font-weight="normal" space-before="18.6624pt" font-family="{$title.fontset}" margin-left="1.5in">
<xsl:apply-templates select="." mode="book.titlepage.recto.mode"/>
</fo:block>
</xsl:template>

<xsl:template match="d:annotation" mode="book.titlepage.recto.auto.mode">
<fo:block xsl:use-attribute-sets="book.titlepage.recto.style" text-align="start" font-size="17.28pt" font-weight="normal" space-before="18.6624pt" font-family="{$title.fontset}" margin-left="1.5in">
<xsl:apply-templates select="." mode="book.titlepage.recto.mode"/>
</fo:block>
</xsl:template>
...
<fo:block xsl:use-attribute-sets="book.titlepage.recto.style" text-align="start" font-size="17.28pt" font-weight="normal" space-before="9pt" font-family="{$title.fontset}" margin-left="1.5in">
<xsl:apply-templates select="." mode="book.titlepage.recto.mode"/>
</fo:block>
</xsl:template>

<xsl:template match="d:legalnotice" mode="book.titlepage.verso.auto.mode">
<fo:block xsl:use-attribute-sets="book.titlepage.verso.style" text-align="start" font-size="12pt" font-weight="normal" space-before="2in" font-family="{$monospace.font.family}" margin-left="0.5in">
