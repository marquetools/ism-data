...
Vendored ODNI **IC-Docbook** schema package, with SHA-256 integrity verification
at compile time.
...
# Cargo.toml
[build-dependencies]
ism-ic-docbook = { git = "https://github.com/marquetools/ism-data", tag = "v..." }
```

```rust,ignore
// build.rs
let xsd = ism_ic_docbook::package_root().join("Schema/IC-Docbook/IC-Docbook.xsd");
