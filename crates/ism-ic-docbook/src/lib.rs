...
pub const PACKAGE_NAME: &str = "IC-Docbook";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "a4ca90871240f57b9c95c5e291bbaf3aa428a8bd34afe739335dbe9766994c71";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 1886;
...
/// Path to the package's data directory: `data/IC-Docbook`.
