...
pub const PACKAGE_NAME: &str = "VIRT";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "0b30fcd296fc937578d5da0734d7951cba9b1bd050a035a56c6713d9d9500a01";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 388;
...
/// Path to the package's data directory: `data/VIRT`.
