...
pub const PACKAGE_NAME: &str = "ICO-ACES";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "9b49363ff85509cbf17247dcf14bced773a7ce7f9ad4ae8f35157994f80168b8";
...
/// Path to the package's data directory: `data/ICO-ACES`.
