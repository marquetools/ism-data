...
pub const PACKAGE_NAME: &str = "NTK-ACES";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "af30cc66438b13c893e54ee15d352cf6baa30bd8b3a45fb247f35a1fddeb10b9";
...
/// Path to the package's data directory: `data/NTK-ACES`.
