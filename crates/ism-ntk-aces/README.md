...
Vendored ODNI **NTK-ACES** schema package, with SHA-256 integrity verification
at compile time.
...
# Cargo.toml
[build-dependencies]
ism-ntk-aces = { git = "https://github.com/marquetools/ism-data", tag = "v..." }
```

```rust,ignore
// build.rs
let xsd = ism_ntk_aces::package_root().join("Schema/NTK-ACES/NTK-ACES.xsd");
