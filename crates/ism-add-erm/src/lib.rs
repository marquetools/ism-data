...
pub const PACKAGE_NAME: &str = "ADD-ERM";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "e0bf1f81662b5ff1e4d913450ee172769a94a99f0b4de91b65cf3ed59b5cebea";
...
/// Path to the package's data directory: `data/ADD-ERM`.
