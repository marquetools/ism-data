...
pub const PACKAGE_NAME: &str = "BOE";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "8f320f57c1c6e2432fc341e8d7a1d1016799ec3ce20d895e395bfc1585b80c11";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 606;
...
/// Path to the package's data directory: `data/BOE`.
