...
pub const PACKAGE_NAME: &str = "ICO-NTK";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "e9d44f70341cbd9f6f9f1ec79dd797b14c24fe135b1becb784293dcde29cae6b";
...
/// Path to the package's data directory: `data/ICO-NTK`.
