...
Vendored ODNI **ICO-NTK** schema package, with SHA-256 integrity verification
at compile time.
...
# Cargo.toml
[build-dependencies]
ism-ico-ntk = { git = "https://github.com/marquetools/ism-data", tag = "v..." }
```

```rust,ignore
// build.rs
let xsd = ism_ico_ntk::package_root().join("Schema/ICO-NTK/ICO-NTK.xsd");
