...
pub const PACKAGE_NAME: &str = "NTK";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "2b8842f1ed87d4101551daf22600e8293c1bdf75d0e684ff7313161319ba0dd7";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 405;
...
/// Path to the package's data directory: `data/NTK`.
