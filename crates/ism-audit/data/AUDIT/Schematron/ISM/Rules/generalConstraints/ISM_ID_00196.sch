...
<sch:pattern id="ISM-ID-00196" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
    <sch:p id="ruleText">[ISM-ID-00196][Warning] Attribute ownerProducer contains a value that will be deprecated.</sch:p>
    ...
    <sch:rule context="*[@ism:ownerProducer]">
        ...
        <sch:assert id="ISM-00196"
            test="count($reportWarn)=0"
            flag="warning">
            [ISM-ID-00196][Warning] For attribute ownerProducer, value(s) <sch:value-of select="$reportWarn"/>
        </sch:assert>
    </sch:rule>
</sch:pattern>