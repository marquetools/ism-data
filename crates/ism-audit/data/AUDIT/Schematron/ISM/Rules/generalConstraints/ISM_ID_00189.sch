...
<sch:pattern id="ISM-ID-00189" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
    <sch:p id="ruleText">[ISM-ID-00189][Error] Attribute FGIsourceOpen must not contain values that have passed their deprecation date.</sch:p>
    ...
    <sch:rule context="*[@ism:FGIsourceOpen]">
        ...
        <sch:assert id="ISM-00189"
            test="count($reportErr)=0"
            flag="error">
            [ISM-ID-00189][Error] For attribute FGIsourceOpen, value(s) <sch:value-of select="$reportErr"/>
        </sch:assert>
    </sch:rule>
</sch:pattern>