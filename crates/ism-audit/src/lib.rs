...
pub const PACKAGE_NAME: &str = "AUDIT";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "f355562a833d7cdf2d42b1d86cbb4b3bacd445bd2a07f124ecc515032e150ca7";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 607;
...
/// Path to the package's data directory: `data/AUDIT`.
