...
pub const PACKAGE_NAME: &str = "WSS-HLG";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "9e79a804129327a6ce676ad22e64bfbb49de6a96856448f2ec9de744447c5dc1";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 4;
...
/// Path to the package's data directory: `data/WSS-HLG`.
