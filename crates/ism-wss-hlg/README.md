...
Vendored ODNI **WSS-HLG** schema package, with SHA-256 integrity verification
at compile time.
...
# Cargo.toml
[build-dependencies]
ism-wss-hlg = { git = "https://github.com/marquetools/ism-data", tag = "v..." }
```

```rust,ignore
// build.rs
let xsd = ism_wss_hlg::package_root().join("Schema/WSS-HLG/WSS-HLG.xsd");
