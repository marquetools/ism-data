...
pub const PACKAGE_NAME: &str = "ISM-ACES";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "e019e994dd575276ba22972998da7f8b1fb03061d4f51e6cfafd354dc7732ec3";
...
/// Path to the package's data directory: `data/ISM-ACES`.
