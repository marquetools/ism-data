...
pub const PACKAGE_NAME: &str = "PM";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "d03ec8a1ce0cc416f63ed3c44972068c5baf9685bf2922ab4f0556dc931ca3f8";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 193;
...
/// Path to the package's data directory: `data/PM`.
