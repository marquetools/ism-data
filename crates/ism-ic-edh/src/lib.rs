...
pub const PACKAGE_NAME: &str = "IC-EDH";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "407966f834ef869675807dc80f7559ad6e0afa0f8b38958a960ca37db26a8400";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 90;
...
/// Path to the package's data directory: `data/IC-EDH`.
