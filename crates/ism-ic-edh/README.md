...
Vendored ODNI **IC-EDH** schema package, with SHA-256 integrity verification
at compile time.
...
# Cargo.toml
[build-dependencies]
ism-ic-edh = { git = "https://github.com/marquetools/ism-data", tag = "v..." }
```

```rust,ignore
// build.rs
let xsd = ism_ic_edh::package_root().join("Schema/IC-EDH/IC-EDH.xsd");
