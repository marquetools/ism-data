...
pub const PACKAGE_NAME: &str = "ERM";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "4d19a77d4a3ab3b1100716b9397b402f1e1974d3eed393359ca0f31bb1d1ff1c";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 190;
...
/// Path to the package's data directory: `data/ERM`.
