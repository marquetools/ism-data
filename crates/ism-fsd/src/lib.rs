...
pub const PACKAGE_NAME: &str = "FSD";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "6c3e366d97c6f886eb09b246949379bb87c8d4faf2203c4b5a9fa7281723bbc6";
...
/// Path to the package's data directory: `data/FSD`.
