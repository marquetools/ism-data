...
pub const PACKAGE_NAME: &str = "MIME";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "b76a2a7b0946bee6add0acb562712eb2e235c8b2a03e458ef0c6246c8223bfec";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 175;
...
/// Path to the package's data directory: `data/MIME`.
