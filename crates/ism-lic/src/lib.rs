...
pub const PACKAGE_NAME: &str = "LIC";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "2f930fdfa760b6911b5645170b8ccf3938f9cf85d6925d561f90b2cf3b398b04";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 278;
...
/// Path to the package's data directory: `data/LIC`.
