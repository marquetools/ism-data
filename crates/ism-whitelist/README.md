...
Vendored ODNI **Whitelist** schema package, with SHA-256 integrity verification
at compile time.
...
# Cargo.toml
[build-dependencies]
ism-whitelist = { git = "https://github.com/marquetools/ism-data", tag = "v..." }
```

```rust,ignore
// build.rs
let xsd = ism_whitelist::package_root().join("Schema/Whitelist/Whitelist.xsd");
