...
pub const PACKAGE_NAME: &str = "Whitelist";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "db8dacc9dfff23d01460c7a5b293b8bc2c71a1f2667a7a678bd9cc4bc3811d79";
...
/// Path to the package's data directory: `data/Whitelist`.
