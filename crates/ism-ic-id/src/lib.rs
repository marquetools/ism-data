...
pub const PACKAGE_NAME: &str = "IC-ID";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "28178d74bfae35245bd36432d954a4ee4e5ae7173b02acf0b02e7ae9ceefb3bf";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 42;
...
/// Path to the package's data directory: `data/IC-ID`.
