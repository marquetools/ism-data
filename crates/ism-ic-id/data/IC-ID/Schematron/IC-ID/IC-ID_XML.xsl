...
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">IC-ID-ID-00001</xsl:attribute>
            <xsl:attribute name="name">IC-ID-ID-00001</xsl:attribute>
            <svrl:text>
        [IC-ID-ID-00001][Warning] icid:DESVersion attribute SHOULD be specified
...
<!--PATTERN IC-ID-ID-00001-->


	<!--RULE IC-ID-ID-00001-R1-->
<xsl:template match="*[@icid:DESVersion]" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[@icid:DESVersion]"
                       id="IC-ID-ID-00001-R1"/>

		    <!--ASSERT warning-->
<xsl:choose>
         <xsl:when test="matches(@icid:DESVersion, '^202111(\-.{1,23})?$')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="matches(@icid:DESVersion, '^202111(\-.{1,23})?$')">
