...
Vendored ODNI **BRK-SRCH** schema package, with SHA-256 integrity verification
at compile time.
...
# Cargo.toml
[build-dependencies]
ism-brk-srch = { git = "https://github.com/marquetools/ism-data", tag = "v..." }
```

```rust,ignore
// build.rs
let xsd = ism_brk_srch::package_root().join("Schema/BRK-SRCH/BRK-SRCH.xsd");
