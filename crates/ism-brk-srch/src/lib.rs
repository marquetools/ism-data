...
pub const PACKAGE_NAME: &str = "BRK-SRCH";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "e5f88552939895f123c2dba9365ca17ede85e5443d5597077ff57eda3bca3e01";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 6;
...
/// Path to the package's data directory: `data/BRK-SRCH`.
