...
<sch:pattern xmlns:ism="urn:us:gov:ic:ism" xmlns:sch="http://purl.oclc.org/dsdl/schematron" 
    id="CDSM-TDF-ID-00003" is-a="ValidateValidationEnvSchema">
    <sch:p class="ruleText" ism:ownerProducer="USA" ism:classification="U">
        [CDSM-TDF-ID-00003][Error] Regardless of the version indicated on the instance document, the validation infrastructure
    ...
    <sch:param name="RuleID" value="'CDSM-TDF-ID-00003'"/>
</sch:pattern>
