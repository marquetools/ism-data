...
Vendored ODNI **CDSM-TDF** schema package, with SHA-256 integrity verification
at compile time.
...
# Cargo.toml
[build-dependencies]
ism-cdsm-tdf = { git = "https://github.com/marquetools/ism-data", tag = "v..." }
```

```rust,ignore
// build.rs
let xsd = ism_cdsm_tdf::package_root().join("Schema/CDSM-TDF/CDSM-TDF.xsd");
