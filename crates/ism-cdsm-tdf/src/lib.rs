...
pub const PACKAGE_NAME: &str = "CDSM-TDF";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "6afb4135372d859972f70a614b394aa164be5d4d8ac5c573abf1718f440a4820";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 392;
...
/// Path to the package's data directory: `data/CDSM-TDF`.
