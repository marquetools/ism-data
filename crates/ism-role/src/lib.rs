...
pub const PACKAGE_NAME: &str = "ROLE";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "d6402398ec238f782994b4a4ca50cd9f28191f10a32fe9de1027593c861deefa";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 200;
...
/// Path to the package's data directory: `data/ROLE`.
