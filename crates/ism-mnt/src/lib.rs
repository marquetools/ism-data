...
pub const PACKAGE_NAME: &str = "MNT";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "34d8ced58fc18d12d2a5393866483d237ee34fed0922915bfddf6331a8026aa3";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 346;
...
/// Path to the package's data directory: `data/MNT`.
