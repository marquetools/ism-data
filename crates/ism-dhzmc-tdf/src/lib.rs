...
pub const PACKAGE_NAME: &str = "DHZMC-TDF";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "e61ee4787ae0b2e1f25db938cc079c3d5b4cf1577afe0935712a516962455772";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 539;
...
/// Path to the package's data directory: `data/DHZMC-TDF`.
