...
Vendored ODNI **DHZMC-TDF** schema package, with SHA-256 integrity verification
at compile time.
...
# Cargo.toml
[build-dependencies]
ism-dhzmc-tdf = { git = "https://github.com/marquetools/ism-data", tag = "v..." }
```

```rust,ignore
// build.rs
let xsd = ism_dhzmc_tdf::package_root().join("Schema/DHZMC-TDF/DHZMC-TDF.xsd");
