...
<?ICEA pattern?><!-- Notices - Distribution Notice: 
    ...
    <sch:p class="ruleText" ism:ownerProducer="USA" ism:classification="U">[PMA-ID-00005][Error] Regardless of the version indicated on the instance document, 
            the validation infrastructure MUST use a version of 'IC-TDF' that is version '201903' (Version:2019-MAR) or later. NOTE: This is not an error of the instance
    ...
    <sch:param name="SpecToCheck" value="'IC-TDF'"/>
    <sch:param name="pathToDocument" value="'../../Schema/IC-TDF/IC-TDF.xsd'"/>
    <sch:param name="RuleID" value="'PMA-ID-00005'"/>
</sch:pattern>