...
<?ICEA pattern?><!-- Notices - Distribution Notice: 
    ...
    <sch:p class="ruleText" ism:ownerProducer="USA" ism:classification="U">[PMA-ID-00006][Error] Regardless of the version indicated on the instance document, 
            the validation infrastructure MUST use a version of 'PM' that is version '201903' (Version:2019-MAR) or later. NOTE: This is not an error of the instance
    ...
    <sch:param name="SpecToCheck" value="'PM'"/>
    <sch:param name="pathToDocument" value="'../../CVE/PM/CVEnumPMSubject.xml'"/>
    <sch:param name="RuleID" value="'PMA-ID-00006'"/>
</sch:pattern>