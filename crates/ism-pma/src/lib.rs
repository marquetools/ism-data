...
pub const PACKAGE_NAME: &str = "PMA";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "2dc37f95ab972c81225ae60ed4e334f0524b18d090fd4af22bff0ae349e6d0d1";

/// Number of files under `data/` covered by the manifest.
pub const FILE_COUNT: usize = 304;
...
/// Path to the package's data directory: `data/PMA`.
