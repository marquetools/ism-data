...
Vendored ODNI **MANAGE** schema package, with SHA-256 integrity verification
at compile time.
...
# Cargo.toml
[build-dependencies]
ism-manage = { git = "https://github.com/marquetools/ism-data", tag = "v..." }
```

```rust,ignore
// build.rs
let xsd = ism_manage::package_root().join("Schema/MANAGE/MANAGE.xsd");
