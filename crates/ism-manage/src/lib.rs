...
pub const PACKAGE_NAME: &str = "MANAGE";

/// SHA-256 of `data/_provenance/manifest.txt`, baked at vendor time.
pub const MANIFEST_DIGEST: &str = "e92aea05458394e7b719a668e2e03f0bc3dd150c4f5b57876bcff6ac7ec80f97";
...
/// Path to the package's data directory: `data/MANAGE`.
