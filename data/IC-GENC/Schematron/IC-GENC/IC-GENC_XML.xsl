...
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">IC-GENC-ID-00001</xsl:attribute>
            <xsl:attribute name="name">IC-GENC-ID-00001</xsl:attribute>
            <svrl:text> 
...
<!--PATTERN IC-GENC-ID-00001-->


	<!--RULE IC-GENC-ID-00001-R1-->
<xsl:template match="*[@genc:CESVersion]" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[@genc:CESVersion]"
                       id="IC-GENC-ID-00001-R1"/>

		    <!--ASSERT warning-->
<xsl:choose>
         <xsl:when test="matches(@genc:CESVersion, '^202111(\-.{1,23})?$')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="matches(@genc:CESVersion, '^202111(\-.{1,23})?$')">
               <xsl:attribute name="flag">warning</xsl:attribute>
               <xsl:attribute name="role">warning</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text> [IC-GENC-ID-00001][Warning] genc:CESVersion attribute SHOULD be
            specified as version 202111 (Version:2021-NOV) with an optional extension. </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
