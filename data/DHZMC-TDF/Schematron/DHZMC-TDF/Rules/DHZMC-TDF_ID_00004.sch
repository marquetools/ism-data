...
<sch:pattern xmlns:ism="urn:us:gov:ic:ism" xmlns:sch="http://purl.oclc.org/dsdl/schematron" 
    id="DHZMC-TDF-ID-00004" is-a="ValidateValidationEnvSchema">
    <sch:p class="ruleText" ism:ownerProducer="USA" ism:classification="U">
        [DHZMC-TDF-ID-00004][Error] Regardless of the version indicated on the instance document, the validation infrastructure
        MUST use a version of 'DHZM' that is version '202111' (Version:2021-NOV) or later. 
    ...
    <sch:param name="RuleID" value="'DHZMC-TDF-ID-00004'"/>
</sch:pattern>
