...
<sch:pattern xmlns:ism="urn:us:gov:ic:ism" xmlns:sch="http://purl.oclc.org/dsdl/schematron" 
    id="DHZMC-TDF-ID-00002" is-a="ValidateValidationEnvSchema">
    <sch:p class="ruleText" ism:ownerProducer="USA" ism:classification="U">
        [DHZMC-TDF-ID-00002][Error] Regardless of the version indicated on the instance document, the validation infrastructure
    ...
    <sch:param name="RuleID" value="'DHZMC-TDF-ID-00002'"/>
</sch:pattern>
