...
<sch:pattern xmlns:ism="urn:us:gov:ic:ism" xmlns:sch="http://purl.oclc.org/dsdl/schematron" 
    id="RevRecall-ID-00013" is-a="ValidateValidationEnvSchema">
    <sch:p class="ruleText" ism:ownerProducer="USA" ism:classification="U">
        [RevRecall-ID-00013][Error] Regardless of the version indicated on the instance document, the validation infrastructure
        MUST use a version of 'ISM' that is version '202111' (Version:2021-NOV) or later. 
    ...
    <sch:param name="RuleID" value="'RevRecall-ID-00013'"/>
</sch:pattern>
