...
<sch:pattern xmlns:ism="urn:us:gov:ic:ism" xmlns:sch="http://purl.oclc.org/dsdl/schematron"
    ...
    <sch:p class="ruleText" ism:ownerProducer="USA" ism:classification="U">
        [IRM-ID-00086][Error] Regardless of the version indicated on the instance document, 
            the validation infrastructure MUST use a version of 'INTDIS' that is version '201707' (Version:2017-JUL) or later. 
    ...
    <sch:param name="pathToDocument" value="'../../CVE/INTDIS/CVEnumIntelDiscipline.xml'"/>
