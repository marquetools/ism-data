...
<sch:pattern xmlns:ism="urn:us:gov:ic:ism" xmlns:sch="http://purl.oclc.org/dsdl/schematron"
    ...
    <sch:p class="ruleText" ism:ownerProducer="USA" ism:classification="U">
        [IRM-ID-00079][Error] Regardless of the version indicated on the instance document, 
            the validation infrastructure MUST use a version of 'IC-ID' that is version '1' or later. 
