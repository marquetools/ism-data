...
<sch:pattern xmlns:ism="urn:us:gov:ic:ism"
    ...
    <sch:p class="ruleText"
           ...
           ism:ownerProducer="USA">[IRM-ID-00053][Error] If element irm:type has attribute @irm:qualifier specified as
           [urn:us:gov:ic:cvenum:irm:activity] the attribute @irm:value must be in CVEnumIRMActivity.xml. Human Readable: Activity must be in the
           CVEnumIRMActivity CVE.</sch:p>
    ...
    <sch:param name="ruleText"
               value="' [IRM-ID-00053][Error] If element irm:type has attribute @irm:qualifier specified as [urn:us:gov:ic:cvenum:irm:activity] the attribute @irm:value must be in CVEnumIRMActivity.xml. Human Readable: Activity must be in the CVEnumIRMActivity CVE. '" />
