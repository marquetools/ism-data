...
<sch:pattern xmlns:ism="urn:us:gov:ic:ism"
    ...
    <sch:p class="ruleText"
           ...
           ism:ownerProducer="USA">[IRM-ID-00073][Error] If element irm:type has attribute @irm:qualifier specified as
           [urn:us:gov:ic:cvenum:irm:positive:intel] the attribute @irm:value must be in CVEnumIRMPositiveIntel.xml. Human Readable: Positive Intel
           values must be in the CVEnumIRMPositiveIntel CVE.</sch:p>
    ...
    <sch:param name="ruleText"
               value="' [IRM-ID-00073][Error] If element irm:type has attribute @irm:qualifier specified as [urn:us:gov:ic:cvenum:irm:positive:intel] the attribute @irm:value must be in CVEnumIRMPositiveIntel.xml. Human Readable: Positive Intel values must be in the CVEnumIRMPositiveIntel CVE. '" />
