...
<sch:pattern xmlns:ism="urn:us:gov:ic:ism"
    ...
    <sch:p class="ruleText"
           ...
           ism:ownerProducer="USA">[IRM-ID-00020][Error] @irm:infoCutOff must not be later than @irm:created, and @irm:posted. Human Readable: The
           date held in the infoCutOff attribute must not be later then the dates held by either the created or posted attributes.</sch:p>
