...
<sch:pattern xmlns:ism="urn:us:gov:ic:ism"
    ...
    <sch:p class="ruleText"
           ...
           ism:ownerProducer="USA">[IRM-ID-00006][Error] If element irm:language has the attribute @irm:qualifier value of
           [urn:us:gov:ic:cvenum:irm:iso639-2:trigraph] then the value of attribute @irm:value must be in CVEnumIRMISO639-2Trigraph.xml and no
           country code portion may be specified in the irm:value attribute value. Human Readable: ISO 639-2 trigraph language codes must be in the
           ISO 639-2 trigraph CVE.</sch:p>
    <sch:p class="codeDesc"
           ...
           if the value of element irm:language is in the appropriate list because if a country code portion is specified in the element
           irm:language's value, then the value of element irm:language will not be found in the appropriate list and the assertion will fail as
           expected.</sch:p>
    <sch:param name="ruleText"
               value="' [IRM-ID-00006][Error] If element irm:language has the attribute @irm:qualifier value of [urn:us:gov:ic:cvenum:irm:iso639-2:trigraph] then the value of attribute @irm:value must be in CVEnumIRMISO639-2Trigraph.xml and no country code portion may be specified in the irm:value attribute value. Human Readable: ISO 639-2 trigraph language codes must be in the ISO 639-2 trigraph CVE. '" />
