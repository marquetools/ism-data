...
<!-- Notices - Distribution Notice: 
       ...
       -->
<sch:pattern xmlns:ism="urn:us:gov:ic:ism" xmlns:sch="http://purl.oclc.org/dsdl/schematron" id="IRM-ID-00111">
    ...
    <sch:p class="codeDesc"  
        ism:classification="U"
        ism:ownerProducer="USA">If irm:virtualCoverage exists, then it must include at least @virt:protocol
        or @virt:address.
    </sch:p>
