      ...
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
        ...
        declares some variables, and includes all of the Rule .sch files.</svrl:text>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">PM-ID-00001</xsl:attribute>
            <xsl:attribute name="name">PM-ID-00001</xsl:attribute>
            <svrl:text>
...
<!--PATTERN PM-ID-00001-->
	...
	<!--RULE PM-ID-00001-R1-->
<xsl:template match="*[@pm:CESVersion]" priority="1000" mode="M3">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[@pm:CESVersion]"
                       id="PM-ID-00001-R1"/>

		    <!--ASSERT warning-->
<xsl:choose>
         <xsl:when test="matches(@pm:CESVersion,'^202211(\-.{1,23})?$')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="matches(@pm:CESVersion,'^202211(\-.{1,23})?$')">
            ...
            [PM-ID-00001][Warning] pm:CESVersion attribute SHOULD be specified as version 202211 (Version:2022-NOV) with an optional extension. 
            Found :<xsl:text/>
                  <xsl:value-of select="./@pm:CESVersion"/>
                  <xsl:text/>
               </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
