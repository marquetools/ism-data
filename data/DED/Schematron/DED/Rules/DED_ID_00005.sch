...
<?ICEA pattern?><!-- Notices - Distribution Notice: 
    ...
    <sch:p class="ruleText" ism:ownerProducer="USA" ism:classification="U">[DED-ID-00005][Error] Regardless of the version indicated on the instance document, 
    ...
    <sch:param name="RuleID" value="'DED-ID-00005'"/>
</sch:pattern>