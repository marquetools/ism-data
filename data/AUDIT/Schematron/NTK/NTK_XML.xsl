...
<!--PATTERN NTK-ID-00002-->
	...
	<!--RULE -->
<xsl:template match="ntk:Access" priority="1000" mode="M8">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <xsl:attribute name="id">NTK-00002</xsl:attribute>
...
<xsl:template match="//*[@*]" priority="1000" mode="M9">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="//*[@*]"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="every $attribute in ./@* satisfies             string-length(normalize-space(string($attribute))) &gt; 0"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="every $attribute in ./@* satisfies string-length(normalize-space(string($attribute))) &gt; 0">
               <xsl:attribute name="id">NTK-00004</xsl:attribute>
               <xsl:attribute name="flag">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
