...
<sch:pattern id="ISM-ID-00042" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
    <sch:p id="ruleText">[ISM-ID-00042][Error] If ISM_CAPCO_RESOURCE and attribute SCIcontrols is specified, each of its values must be 
        ordered in accordance with CVEnumISMSCIControls.xml.
    </sch:p>
    <sch:p id="codeDesc">To perform sorting, this rule first retrieves the CVE values for the attribute 
    ...
    <sch:rule context="*[@ism:SCIcontrols]">
        ...
        <sch:let name="errMsg_AlphabeticalOrder" value="'
            [ISM-ID-00042][Error] If ISM_CAPCO_RESOURCE and attribute SCIcontrols is specified, each of its values must be 
            ordered in accordance with CVEnumISMSCIControls.xml.
            '"/>
