...
<sch:pattern id="ISM-ID-00198" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
    <sch:p id="ruleText">[ISM-ID-00198][Warning] Attribute releasableTo contains a value that will be deprecated.</sch:p>
    ...
    <sch:rule context="*[@ism:releasableTo]">
        ...
        <sch:assert id="ISM-00198"
            test="count($reportWarn)=0"
            flag="warning">
            [ISM-ID-00198][Warning] For attribute releasableTo, value(s) <sch:value-of select="$reportWarn"/>
        </sch:assert>
    </sch:rule>
</sch:pattern>