...
<sch:pattern id="ISM-ID-00206" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
    <sch:p id="ruleText">[ISM-ID-00206][Warning] Attribute declassException contains a value that will be deprecated.</sch:p>
    ...
    <sch:rule context="*[@ism:declassException]">
        ...
        <sch:assert id="ISM-00206"
            test="count($reportWarn)=0"
            flag="warning">
            [ISM-ID-00206][Warning] For attribute declassException, value(s) <sch:value-of select="$reportWarn"/>
        </sch:assert>
    </sch:rule>
</sch:pattern>