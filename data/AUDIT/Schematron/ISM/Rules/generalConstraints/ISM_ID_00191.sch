...
<sch:pattern id="ISM-ID-00191" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
    <sch:p id="ruleText">[ISM-ID-00191][Error] Attribute FGIsourceProtected must not contain values that have passed their deprecation date.</sch:p>
    ...
    <sch:rule context="*[@ism:FGIsourceProtected]">
        ...
        <sch:assert id="ISM-00191"
            test="count($reportErr)=0"
            flag="error">
            [ISM-ID-00191][Error] For attribute FGIsourceProtected, value(s) <sch:value-of select="$reportErr"/>
        </sch:assert>
    </sch:rule>
</sch:pattern>