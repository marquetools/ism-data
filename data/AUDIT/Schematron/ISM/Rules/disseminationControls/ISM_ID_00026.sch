...
<sch:pattern id="ISM-ID-00026" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
    
    <sch:p id="ruleText">[ISM-ID-00026][Error] If ISM_CAPCO_RESOURCE and attribute 
        disseminationControls is specified, then each of its values must be ordered in accordance with 
        CVEnumISMDissem.xml.</sch:p>
    ...
    <sch:rule context="*[@ism:disseminationControls and $ISM_CAPCO_RESOURCE]">
        ...
        <sch:let name="errMsg_AlphabeticalOrder" value="
            '[ISM-ID-00026][Error] If ISM_CAPCO_RESOURCE and attribute 
            disseminationControls is specified, then each of its values must be ordered in accordance with 
            CVEnumISMDissem.xml.'"/>
