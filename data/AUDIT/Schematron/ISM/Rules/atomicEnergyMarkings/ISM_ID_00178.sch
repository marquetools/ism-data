...
<sch:pattern id="ISM-ID-00178" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
    
    <sch:p id="ruleText">[ISM-ID-00178][Error] If ISM_CAPCO_RESOURCE and attribute 
        atomicEnergyMarkings is specified, then each of its values must be ordered in accordance with 
        CVEnumISMAtomicEnergyMarkings.xml.</sch:p>
    ...
    <sch:rule context="*[@ism:atomicEnergyMarkings]">
        ...
        <sch:let name="errMsg_AlphabeticalOrder" value="
            '[ISM-ID-00178][Error] If ISM_CAPCO_RESOURCE and attribute 
            atomicEnergyMarkings is specified, then each of its values must be ordered in accordance with 
