...
<!--UNCLASSIFIED--><xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
                ...
                xmlns:cdsm="urn:us:gov:ic:cdsmanifest"
...
<xsl:template match="/">
      ...
      declares some variables, and includes all of the Rule .sch files.</svrl:text>
         ...
         <svrl:ns-prefix-in-attribute-values uri="urn:us:gov:ic:cdsmanifest" prefix="cdsm"/>
         <svrl:active-pattern>
            <xsl:attribute name="document">
               <xsl:value-of select="document-uri(/)"/>
            </xsl:attribute>
            <xsl:attribute name="id">CDSM-TDF-ID-00001</xsl:attribute>
            <xsl:attribute name="name">CDSM-TDF-ID-00001</xsl:attribute>
            <svrl:text>
        [CDSM-TDF-ID-00001][Warning] tdf:version attribute SHOULD be specified as version 202111-CDSM-TDF.202111 
        ...
        “^202111-CDSM-TDF.202111(-.{1,23})?$".
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">CDSM-TDF-ID-00002</xsl:attribute>
            <xsl:attribute name="name">CDSM-TDF-ID-00002</xsl:attribute>
            <svrl:text>
        ...
        The calling rule must pass in '202111', 'IC-SF', '../../Schema/IC-SF/IC-SF.xsd', 'CDSM-TDF-ID-00002'.</svrl:text>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">CDSM-TDF-ID-00003</xsl:attribute>
            <xsl:attribute name="name">CDSM-TDF-ID-00003</xsl:attribute>
            <svrl:text>
        This abstract pattern checks to see if the validation environment has at least the version / revision of the
        Schema as of the writing of this specification. 
        The calling rule must pass in '202111', 'BASE-TDF', '../../Schema/BASE-TDF/BASE-TDF.xsd', 'CDSM-TDF-ID-00003'.</svrl:text>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">CDSM-TDF-ID-00004</xsl:attribute>
            <xsl:attribute name="name">CDSM-TDF-ID-00004</xsl:attribute>
            <svrl:text>
        This abstract pattern checks to see if the validation environment has at least the version / revision of the
        Schema as of the writing of this specification. 
        The calling rule must pass in '202111', 'CDSM', '../../Schema/CDSM/CDSM.xsd', 'CDSM-TDF-ID-00004'.</svrl:text>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">CDSM-TDF-ID-00005</xsl:attribute>
            <xsl:attribute name="name">CDSM-TDF-ID-00005</xsl:attribute>
            <svrl:text>
        This abstract pattern checks to see if the validation environment has at least the version / revision of the
        Schema as of the writing of this specification. 
        The calling rule must pass in '202111', 'ANLYS', '../../Schema/ANLYS/ANLYS.xsd', 'CDSM-TDF-ID-00005'.</svrl:text>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">CDSM-TDF-ID-00006</xsl:attribute>
            <xsl:attribute name="name">CDSM-TDF-ID-00006</xsl:attribute>
            <svrl:text>
...
<!--PATTERN CDSM-TDF-ID-00001-->


	<!--RULE CDSM-TDF-ID-00001-R1-->
<xsl:template match="*[@tdf:version]" priority="1000" mode="M8">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[@tdf:version]"
                       id="CDSM-TDF-ID-00001-R1"/>

		    <!--ASSERT warning-->
<xsl:choose>
         <xsl:when test="matches(@tdf:version,'^202111-CDSM-TDF.202111(\-.{1,23})?$')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="matches(@tdf:version,'^202111-CDSM-TDF.202111(\-.{1,23})?$')">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text> 
            [<xsl:text/>
                  <xsl:value-of select="'CDSM-TDF-ID-00002'"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text> 
            [<xsl:text/>
                  <xsl:value-of select="'CDSM-TDF-ID-00003'"/>
                  <xsl:text/>][Error] Version [ <xsl:text/>
...
<xsl:template match="/" priority="1000" mode="M11">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="document('../../Schema/CDSM/CDSM.xsd')//xsd:schema//@version castable as xs:double              and document('../../Schema/CDSM/CDSM.xsd')//xsd:schema//@version &gt;= '202111'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="document('../../Schema/CDSM/CDSM.xsd')//xsd:schema//@version castable as xs:double and document('../../Schema/CDSM/CDSM.xsd')//xsd:schema//@version &gt;= '202111'">
               <xsl:attribute name="flag">error</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               ...
               <svrl:text> 
            [<xsl:text/>
                  <xsl:value-of select="'CDSM-TDF-ID-00004'"/>
                  <xsl:text/>][Error] Version [ <xsl:text/>
                  <xsl:value-of select="document('../../Schema/CDSM/CDSM.xsd')//xsd:schema//@version"/>
                  <xsl:text/> ] of <xsl:text/>
                  <xsl:value-of select="'CDSM'"/>
                  <xsl:text/> found; 
            Version [<xsl:text/>
                  <xsl:value-of select="'202111'"/>
                  <xsl:text/>] or later is required. The latest version of <xsl:text/>
            ...
            version [<xsl:text/>
                  ...
                  <xsl:text/>] or later. NOTE: This is not an error of the instance
            document but of the validation environment itself. The incorrect value was found in <xsl:text/>
                  <xsl:value-of select="document-uri(document('../../Schema/CDSM/CDSM.xsd'))"/>
                  <xsl:text/>
               </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text> 
            [<xsl:text/>
                  <xsl:value-of select="'CDSM-TDF-ID-00005'"/>
                  <xsl:text/>][Error] Version [ <xsl:text/>
   ...
   <!--PATTERN CDSM-TDF-ID-00006-->


	<!--RULE CDSM-TDF-ID-00006-R1-->
<xsl:template match="tdf:TrustedDataObject" priority="1000" mode="M13">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="tdf:TrustedDataObject"
                       id="CDSM-TDF-ID-00006-R1"/>

		    <!--ASSERT error-->
<xsl:choose>
         <xsl:when test=".//cdsm:CdsManifestAssertion and count(.//cdsm:CdsManifestAssertion) = 1"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test=".//cdsm:CdsManifestAssertion and count(.//cdsm:CdsManifestAssertion) = 1">
               <xsl:attribute name="flag">error</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
