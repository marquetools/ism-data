...
<sch:pattern xmlns:ism="urn:us:gov:ic:ism" xmlns:sch="http://purl.oclc.org/dsdl/schematron"
    id="DHZM-TDF-ID-00006" is-a="ValidateValidationEnvSchema">
    <sch:p class="ruleText" ism:ownerProducer="USA" ism:classification="U">
        [DHZM-TDF-ID-00006][Error] Regardless of the version indicated on the instance document,
        the validation infrastructure MUST use a version of 'IC-SF' that is version '202111' (Version:2021-NOV) or
    ...
    <sch:param name="RuleID" value="'DHZM-TDF-ID-00006'"/>
</sch:pattern>
