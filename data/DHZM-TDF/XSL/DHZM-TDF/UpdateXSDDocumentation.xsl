...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xd:doc scope="stylesheet">
        <xd:desc>
            ...
            <xd:p>Update the header and footer annotation documentation in the generated DHZM-TDF XSD.</xd:p>
        </xd:desc>
    </xd:doc>
        ...
        <xs:annotation>
            <xs:documentation>
                <xhtml:h1 ism:ownerProducer="USA" ism:classification="U">Intelligence Community
                    Technical Specification XML Data Encoding Specification for DigitalHazMat TDF
                    (DHZM-TDF.XML)</xhtml:h1>
            </xs:documentation>
            <xs:documentation>
           ...
           This document has been approved for Public Release and is available for use without restriction.
            ...
            <xs:documentation>
                ...
                <xhtml:p ism:ownerProducer="USA" ism:classification="U">This XML Schema file is one
                    component of the XML Data Encoding Specification (DES). Please see the document titled<xhtml:i>
                        <xhtml:a href="../../Documents/DHZM-TDF/DesDhzmTdfXml.pdf">XML Data Encoding Specification for DigitalHazMat TDF</xhtml:a>
                ...
                <xhtml:p ism:ownerProducer="USA" ism:classification="U">If you modify this XML Schema in
                    any way label your schema as a variant of DHZM-TDF.XML.</xhtml:p>
            ...
            <xs:documentation>
                ...
                <xhtml:p ism:ownerProducer="USA" ism:classification="U">The root element for DHZM-TDF is:
                    <xhtml:a href="DHZM-TDF_xsd_Element_TrustedDataObject.html#TrustedDataObject">tdf:TrustedDataObject</xhtml:a>
                </xhtml:p>
            </xs:documentation>
            <xs:documentation>
