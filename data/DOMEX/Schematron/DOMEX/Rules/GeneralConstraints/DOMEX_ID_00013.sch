...
<sch:pattern xmlns:ism="urn:us:gov:ic:ism" xmlns:sch="http://purl.oclc.org/dsdl/schematron"
    ...
    <sch:p class="ruleText" ism:ownerProducer="USA" ism:classification="U">
        [DOMEX-ID-00013][Error] Regardless of the version indicated on the instance document, 
        the validation infrastructure MUST use a version of 'USAgency' that is version '201703.201802' (Version:2017-MAR Revision:2018-FEB) or later. 
    ...
    <sch:param name="RuleID" value="'DOMEX-ID-00013'"/>
</sch:pattern>