...
<sch:pattern xmlns:ism="urn:us:gov:ic:ism" xmlns:sch="http://purl.oclc.org/dsdl/schematron"
    ...
    <sch:p class="ruleText" ism:ownerProducer="USA" ism:classification="U">
        [DOMEX-ID-00014][Error] Regardless of the version indicated on the instance document, 
        the validation infrastructure MUST use a version of 'MIME' that is version '202010' (Version:2020-OCT) or later. 
    ...
    <sch:param name="RuleID" value="'DOMEX-ID-00014'"/>
</sch:pattern>