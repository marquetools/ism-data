...
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:text/>
         <svrl:ns-prefix-in-attribute-values uri="http://docbook.org/ns/docbook" prefix="d"/>
         <svrl:ns-prefix-in-attribute-values uri="urn:us:gov:ic:ism" prefix="ism"/>
         <svrl:active-pattern>
            <xsl:attribute name="document">
               <xsl:value-of select="document-uri(/)"/>
            </xsl:attribute>
            <xsl:attribute name="id">IC-Docbook-ID-00001</xsl:attribute>
            <xsl:attribute name="name">IC-Docbook-ID-00001</xsl:attribute>
            <svrl:text>
        ...
        matches the version of this rule set.
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">IC-Docbook-ID-00002</xsl:attribute>
            <xsl:attribute name="name">IC-Docbook-ID-00002</xsl:attribute>
            <svrl:text>
...
<!--PATTERN IC-Docbook-ID-00001-->


	<!--RULE IC-Docbook-ID-00001-R1-->
<xsl:template match="d:*[@version]" priority="1000" mode="M3">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="d:*[@version]"
                       id="IC-Docbook-ID-00001-R1"/>

		    <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="matches(@version, '^5.0-variant urn:us:gov:ic:docbook-201804')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="matches(@version, '^5.0-variant urn:us:gov:ic:docbook-201804')">
   ...
   <!--PATTERN IC-Docbook-ID-00002-->


	<!--RULE IC-Docbook-ID-00002-R1-->
<xsl:template match="*[@ism:DESVersion]" priority="1000" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[@ism:DESVersion]"
                       id="IC-Docbook-ID-00002-R1"/>
