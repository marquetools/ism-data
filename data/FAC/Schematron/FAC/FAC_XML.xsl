...
<!--UNCLASSIFIED--><xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
                ...
                xmlns:fac="urn:us:gov:ic:fineaccesscontrol"
...
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
        ...
        declares some variables, and includes all of the Rule .sch files.</svrl:text>
         ...
         <svrl:ns-prefix-in-attribute-values uri="urn:us:gov:ic:fineaccesscontrol" prefix="fac"/>
         <svrl:active-pattern>
            <xsl:attribute name="document">
               <xsl:value-of select="document-uri(/)"/>
            </xsl:attribute>
            <xsl:attribute name="id">FAC-ID-00001</xsl:attribute>
            <xsl:attribute name="name">FAC-ID-00001</xsl:attribute>
            <svrl:text>
...
<!--PATTERN FAC-ID-00001-->


	<!--RULE FAC-ID-00001-R1-->
<xsl:template match="*[@fac:CESVersion]" priority="1000" mode="M3">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[@fac:CESVersion]"
                       id="FAC-ID-00001-R1"/>

		    <!--ASSERT warning-->
<xsl:choose>
         <xsl:when test="matches(@fac:CESVersion,'^202211(\-.{1,23})?$')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="matches(@fac:CESVersion,'^202211(\-.{1,23})?$')">
