...
<sch:pattern xmlns:ism="urn:us:gov:ic:ism" xmlns:sch="http://purl.oclc.org/dsdl/schematron"
    ...
    <sch:p class="ruleText" ism:ownerProducer="USA" ism:classification="U">
        [UIAS-ID-00077][Error] Regardless of the version indicated on the instance document, 
        the validation infrastructure MUST use a version of 'ROLE' that is version '202111' (Version:2021-NOV) or later. 
    ...
    <sch:param name="SpecToCheck" value="'ROLE'"/>
    <sch:param name="pathToDocument" value="'../../CVE/ROLE/CVEnumROLEC2SFunction.xml'"/>
    <sch:param name="RuleID" value="'UIAS-ID-00077'"/>
</sch:pattern>